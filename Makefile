...
gen_tree:
	-$(PYTHON) model/decision_tree.py 15 14 1 1 1 10 0.5 0.0 1 0 "" 16
...
test_tree_light:
	DATA_PATH=".." PROGRAM_PATH="./.." $(CARGO) test test_dymel_test_light --bin simulation --manifest-path "simulation/Cargo.toml" --features "feature_set10" -- --nocapture
