...
gen_tree:
	-$(PYTHON) model/decision_tree.py 25 16 1 1 0 8 0.5 0.0 1 0 "" 16
...
test_tree_klisch:
	DATA_PATH=".." PROGRAM_PATH="./.." $(CARGO) test test_klisch_test_by_annotation --bin simulation --manifest-path "simulation/Cargo.toml" --features "feature_set8" -- --nocapture
...
test_tree_light:
	DATA_PATH=".." PROGRAM_PATH="./.." $(CARGO) test test_dymel_test_light --bin simulation --manifest-path "simulation/Cargo.toml" --features "feature_set8" -- --nocapture
