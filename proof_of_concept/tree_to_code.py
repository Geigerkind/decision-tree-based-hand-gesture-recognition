...
def tree_to_code(tree, feature_names=range(0, 28)):
    ...
    file.write("unsigned char GestureClassificationDecisionTree(short int* features)")
    file.write("{")
    ...
    def recurse(node, depth):
        ...
        if tree_.feature[node] != _tree.TREE_UNDEFINED:
            ...
            file.write("\n{}return {};\n".format(indent, classification_index))
    ...
    file.write("char result = GestureClassificationDecisionTree(args);\n")
