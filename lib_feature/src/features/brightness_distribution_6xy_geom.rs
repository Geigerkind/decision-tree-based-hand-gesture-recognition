...
/// See the calc_brightness_distribution_float_xy_geom
pub struct BrightnessDistribution6XYGeom(pub [usize; 6]);
...
mod test {
    ...
    fn test_calculate() {
        ...
        // Act
        let feature = BrightnessDistribution6XYGeom::calculate(&gesture);
    ...
    fn test_marshal() {
        // Arrange
        let feature = BrightnessDistribution6XYGeom([0, 1, 2, 3, 4, 5]);
