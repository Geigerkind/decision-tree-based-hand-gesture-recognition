...
/// See calc_darkness_distribution_float_xy_quadrant
pub struct DarknessDistribution6XYQuadrant(pub [usize; 6]);
...
mod test {
    ...
    use crate::features::{DarknessDistribution6XYQuadrant, Feature};
    ...
    fn test_calculate() {
        ...
        // Act
        let feature = DarknessDistribution6XYQuadrant::calculate(&gesture);

        // Assert
        assert_eq!(feature.deref(), &[0, 1, 2, 3, 3, 3]);
    }
    ...
    fn test_calculate_6_frames() {
        ...
        // Assert
        assert_eq!(feature.deref(), &[0, 1, 1, 2, 3, 3]);
    }

    #[test]
    fn test_marshal() {
        // Arrange
        let feature = DarknessDistribution6XYQuadrant([0, 1, 2, 3, 4, 5]);
