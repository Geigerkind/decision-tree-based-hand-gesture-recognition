...
/// See calc_darkness_distribution_float_y
pub struct DarknessDistribution6Y(pub [f32; 6]);
...
mod test {
    ...
    use crate::features::{DarknessDistribution6Y, Feature};
    ...
    fn test_calculate() {
        ...
        let frame6 = Frame::from_str("100,100,100,100,100,100,90,100,100,1").unwrap();
        ...
        // Act
        let feature = DarknessDistribution6Y::calculate(&gesture);

        // Assert
        assert_eq!(feature.deref(), &[0.0, 1.0, 1.5, 2.0, 2.0, 2.0]);
    }
    ...
    fn test_calculate_6_frames() {
        ...
        let frame4 = Frame::from_str("100,100,100,100,100,100,100,100,90,1").unwrap();
        let frame5 = Frame::from_str("100,100,100,100,100,90,100,100,100,1").unwrap();
        ...
        // Assert
        assert_eq!(feature.deref(), &[0.0, 1.0, 2.0, 2.0, 1.0, 0.0]);
    }

    #[test]
    fn test_marshal() {
        // Arrange
        let feature = DarknessDistribution6Y([0.1, 1.1, 2.1, 0.1, 1.1, 2.1]);
