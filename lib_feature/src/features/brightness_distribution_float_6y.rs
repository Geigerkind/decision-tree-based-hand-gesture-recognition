...
mod test {
    ...
    use crate::features::{BrightnessDistribution6Y, Feature};
    ...
    fn test_calculate() {
        ...
        let frame6 = Frame::from_str("100,100,100,100,100,100,110,100,100,1").unwrap();
        ...
        // Act
        let feature = BrightnessDistribution6Y::calculate(&gesture);
    ...
    fn test_calculate_6_frames() {
        ...
        let frame4 = Frame::from_str("100,100,100,100,100,100,100,100,110,1").unwrap();
        let frame5 = Frame::from_str("100,100,100,100,100,110,100,100,100,1").unwrap();
    ...
    fn test_marshal() {
        // Arrange
        let feature = BrightnessDistribution6Y([0.1, 1.1, 2.1, 0.1, 1.1, 2.1]);
