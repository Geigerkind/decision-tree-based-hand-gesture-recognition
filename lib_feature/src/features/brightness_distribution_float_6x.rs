...
pub struct BrightnessDistribution6X(pub [f32; 6]);
...
mod test {
    ...
    use crate::features::{BrightnessDistribution6X, Feature};
    ...
    fn test_calculate() {
        ...
        // Act
        let feature = BrightnessDistribution6X::calculate(&gesture);
    ...
    fn test_calculate_6_frames() {
        ...
        let frame4 = Frame::from_str("110,100,100,100,100,100,100,100,100,1").unwrap();
        let frame5 = Frame::from_str("100,110,100,100,100,100,100,100,100,1").unwrap();
        let frame6 = Frame::from_str("100,100,110,100,100,100,100,100,100,1").unwrap();
        let mut gesture = Gesture::default();
        gesture.frames.push(frame1);
        gesture.frames.push(frame2);
    ...
    fn test_marshal() {
        // Arrange
        let feature = BrightnessDistribution6X([0.1, 1.1, 2.1, 0.1, 1.1, 2.1]);
